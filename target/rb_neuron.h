...
*/
class rb_neuron : public nest::Archiving_Node{
public:
  /**
...
private:
  ...
  friend class nest::RecordablesMap<rb_neuron>;
  friend class nest::UniversalDataLogger<rb_neuron>;
  ...
  */
  ...
  struct Buffers_ {
    Buffers_(rb_neuron &);
    Buffers_(const Buffers_ &, rb_neuron &);

    /** Logger for all analog data */
    nest::UniversalDataLogger<rb_neuron> logger_;
  ...
  inline double get_desired() const {
    return P_.desired;
  }
  inline void set_desired(const double __v) {
    P_.desired = __v;
  }
  ...
  */
  ...
  static nest::RecordablesMap<rb_neuron> recordablesMap_;
...
inline nest::port rb_neuron::send_test_event(
...
inline nest::port rb_neuron::handles_test_event(nest::SpikeEvent&, nest::port receptor_type){
...
inline nest::port rb_neuron::handles_test_event(
...
inline void rb_neuron::get_status(DictionaryDatum &__d) const{
  def<double>(__d, "kp", get_kp());

  def<double>(__d, "desired", get_desired());
...
inline void rb_neuron::set_status(const DictionaryDatum &__d){
  ...
  updateValue<double>(__d, "desired", tmp_desired);
