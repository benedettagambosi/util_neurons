...
*/
class state_neuron : public nest::Archiving_Node{
public:
  /**
...
private:
  ...
  friend class nest::RecordablesMap<state_neuron>;
  friend class nest::UniversalDataLogger<state_neuron>;
  ...
  */
  ...
  struct Buffers_ {
    ...
    nest::UniversalDataLogger<state_neuron> logger_;
  ...
  inline void set_num_first(const double __v) {
    P_.num_first = __v;
  }

  inline double get_num_second() const {
    return P_.num_second;
  }
  inline void set_num_second(const double __v) {
    P_.num_second = __v;
  }
  ...
  */
  ...
  static nest::RecordablesMap<state_neuron> recordablesMap_;
...
inline nest::port state_neuron::send_test_event(
...
inline nest::port state_neuron::handles_test_event(nest::SpikeEvent&, nest::port receptor_type){
...
inline nest::port state_neuron::handles_test_event(
...
inline void state_neuron::set_status(const DictionaryDatum &__d){
  ...
  double tmp_num_second = get_num_second();
  updateValue<double>(__d, "num_second", tmp_num_second);
